        ...
        <div class="box-content form-horizontal frm-entity frm-detail">
            <div class="control-group form-group">
                ...
                <div class="controls col-md-9">
                   ...
                   <!--  <switch_publisher :publisher_param='"cps_api"' :publisher_val="offlineAPIInfo.access" :showAlert='showAlert' :renderPublisher="renderPublisher" :switchDefaultAPI="'Publisher/saveProductAccess'" :getCustomParam="getCustomParam" :onSuccess="getProductInfo"></switch_publisher>
                    -->
                    <common-switch
                        :showAlert='showAlert'
                        :default_val="offlineAPIInfo.access"
                        :switch_param='"cps_api"'
...
export default {
    ...
    methods: {
        ...
        getProductInfo(param,value,callback){
            let that = this
            publisherAPI.getProductInfo({publisher_id:this.$route.query.id, product:"cps_api"}, function(data){
