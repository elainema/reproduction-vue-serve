                ...
                <div class="box-container" id="filter_check_box">
                    ...
                    <div class="box-content">
                        <div class="form-group field-required mt15">
                            <label for="" class="col-md-2 control-label">Referring PM</label>
                            <div class="col-md-10">

                                <select2Aff   :select2_mode='"simple"':select2_class="'col-md-7 nopadding'"   :aff_name='""' class="nomargin"></select2Aff>
                        ...
                        <div class="form-actions col-md-offset-2">
                            ...
                            <a type="btn" href="manager_commission" class="btn btn-default" id="">Reset</a>
                        ...
                        <div id="report_container">
                            ...
                            <div class="box-content overflow_scroll">
                                <table class="list-table table table-hover tablesorter" id="report_list">
                                    ...
                                    <thead class="cap">
                                        <tr>
                                            <th class="tl-left">Referring PM</th>
                                    ...
                                    <tbody id="rp_list" v-if="reportData.length > 0">
                                        <tr v-if="display_referred_aff" v-for="i in reportData">
                                            <td>{{ i.am_first_name }} {{ i.am_last_name }}</td>
                                            <td>{{ i.aff_id }}</td>
                                            <td>{{ i.aff_first_name }} {{ i.aff_last_name }}</td>
                                            <td>${{ i.revenue }}</td>
                                        </tr>
                                        <tr  v-if="!display_referred_aff" v-for="i in reportData">
                                            <td>{{ i.am_first_name }} {{ i.am_last_name }}</td>
...
export default {
  ...
  components: { dateTimePicker_range, pagination, AlertPop, select2Aff,Modal},
  methods: {
    hideModal() {
    ...
    ExportReportShow() {
        ...
        Vue.http.get('Report/getExportAmReferredAff', {params:param}).then(response => {
            that.loadingZone = ""
    ...
    submitForm:function(){
        ...
        that.reportName = [];
        //this.resetReportCal()
        Vue.http.get('Report/getAmReferredAff', {params:param}).then(response => {
            that.loadingZone = ""
            if(!response.body.data){
